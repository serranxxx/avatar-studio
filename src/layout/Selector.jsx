...
export const Selector = (props) => {
    ...
    useEffect(() => {
        const typeOfsize = () => {
            ...
            if (props.type === 'hair') setCurrent([hairs.hair_0, hairs.hair_2, hairs.hair_4, hairs.hair_5])
            if (props.type === 'glasses') setCurrent([glasses.glass_0, glasses.glass_1, glasses.glass_2, glasses.glass_3, glasses.glass_4, glasses.glass_6, glasses.glass_7, glasses.glass_8])
