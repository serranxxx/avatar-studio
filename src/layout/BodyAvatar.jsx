...
export const HeadAvatarSmall = (props) => {
...
export const HairAvatarSmall = (props) => {
    return (
        <div
            // className='hair-style'
            style={{
...
export const GlassesAvatarSmall = (props) => {
...
export const HatsAvatarSmall = (props) => {
...
export const BeardAvatarSmall = (props) => {
